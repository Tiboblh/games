  ...
  const b = class extends DOMHandler {
    constructor(t) {
      super(t, "runtime"),
        ...
        t.AddRuntimeComponentMessageHandler("runtime", "alert", (e) =>
          this._OnAlert(e)
        );
...
}
{
  ...
  const t = class extends DOMHandler {
    ...
    *audioInstancesByTag(t) {
    ...
    PostTrigger(e, t, n) {
      this.PostToRuntime("trigger", { type: e, tag: t, aiid: n });
    }
    async _Play(t) {
    ...
    SetAudioParam(t, n, a, o) {
      ...
      (o += i),
        0 === a
          ...
          : 2 === a
          ? (t.setValueAtTime(t.value, i), t.exponentialRampToValueAtTime(n, o))
          : void 0;
    }
    GetState() {
